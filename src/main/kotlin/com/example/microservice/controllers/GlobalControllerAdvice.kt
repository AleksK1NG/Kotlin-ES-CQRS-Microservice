...
class GlobalControllerAdvice {
    ...
    fun handleInvalidArgument(ex: MethodArgumentNotValidException): ResponseEntity<Map<String, String>>? {
    ...
    fun handleWebExchangeInvalidArgument(ex: WebExchangeBindException): ResponseEntity<Map<String, Any?>> {
